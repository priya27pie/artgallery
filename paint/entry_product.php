        ...
        $(document).ready(function(){
            ...
            $('#addmore').click(function(){
              ...
              //  alert('ss');
                ...
                var html = "<div class='tr_input'><table class='table'><tbody><tr><td><input type='text' id='testcode_"+index+"' name='size[]'/></td><td><input type='text' id='testcode_"+index+"' name='price[]'/></td><td><a href='javascript:void(0);' id='remove_field' class='remCF' >-</a></td></tr></tbody></table></div>";
